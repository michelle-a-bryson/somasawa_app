import 'bloc/curriculum_calendar_weekly_bloc.dart';
import 'models/curriculum_calendar_weekly_model.dart';
...
class CurriculumCalendarWeeklyPage extends StatefulWidget {
  const CurriculumCalendarWeeklyPage({Key? key}) : super(key: key);

  @override
  CurriculumCalendarWeeklyPageState createState() =>
      CurriculumCalendarWeeklyPageState();

  static Widget builder(BuildContext context) {
    return BlocProvider<CurriculumCalendarWeeklyBloc>(
        create: (context) => CurriculumCalendarWeeklyBloc(
            CurriculumCalendarWeeklyState(
                curriculumCalendarWeeklyModelObj:
                CurriculumCalendarWeeklyModel()))
          ..add(CurriculumCalendarWeeklyInitialEvent()),
        child: CurriculumCalendarWeeklyPage());
  }
}

class CurriculumCalendarWeeklyPageState
    extends State<CurriculumCalendarWeeklyPage>
    with AutomaticKeepAliveClientMixin<CurriculumCalendarWeeklyPage> {
  @override
  ...
  Widget _buildDatepickerWDate(BuildContext context) {
    return BlocBuilder<CurriculumCalendarWeeklyBloc,
        CurriculumCalendarWeeklyState>(builder: (context, state) {
      return SizedBox(
          height: 160.v,
          width: 328.h,
          child: TableCalendar(
      ...
      Padding(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Padding(
                ...
                child: Text("msg_july_11_tuesday".tr,
